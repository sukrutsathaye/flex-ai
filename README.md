...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/i5MwBUeikD)
...
```sh
npx nx serve flex-ai
```

To create a production bundle:

```sh
npx nx build flex-ai
```

To see all available targets to run for a project, run:

```sh
npx nx show project flex-ai
```
...
# For UI Component Design We shall use Storybook